...
`
    ...
    const observer_menu = new MutationObserver(doShit);
    ...
    const observer_gametables = new MutationObserver(improveGameTables);
    ...
    function doShit() {
        ...
        console.log('doshit()');
        if (/boardgamearena\.com\/lobby/.test(document.baseURI) && document.querySelector('#ebBox-GameTableMgr') == null) {
            console.log('doShit() ui()');
            gameTables_page_ui();
        }
    }
    ...
    function betterPlayerColorNotification() {
        if (document.querySelector('#pagemaintitletext') != null) {
            ...
            //document.querySelector('#board').style.boxShadow = '0px 20px 999px -5px #'+userColor;
        }
    }
